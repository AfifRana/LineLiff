window.onload = function() {
    ...
    const defaultLiffId = "1653780304-Y9XbXEqk";   // change the default LIFF value if you are not using a node server
...
function registerButtonHandlers() {
    ...
    //     liff.openWindow({
    //         url: 'https://submissionliff3.herokuapp.com/', // Isi dengan Endpoint URL aplikasi web Anda
    //         external: true
    //     });
    // });
	...
	document.getElementById('sendMessageButton').addEventListener('click', function() {
        document.getElementById('result2').innerHTML = "Masuk 3";
        if (!liff.isInClient()) {
            sendAlertIfNotInClient();
            document.getElementById('result2').textContent = "Masuk 1";
        } else {
            document.getElementById('result2').innerHTML = "Masuk 2";
            liff.sendMessages([{
                'type': 'text',
